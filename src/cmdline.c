/*
  ...
  gengetopt --arg-struct-name=cmd_params --input=cmd_line.ggo --output-dir=../../src --include-getopt 
...
const char *cmd_params_purpose = "for phd";

const char *cmd_params_usage = "Usage: saddlepoint_finder_2d [OPTIONS]...";

const char *cmd_params_versiontext = "";
...
static
void clear_given (struct cmd_params *args_info);
static
void clear_args (struct cmd_params *args_info);

static int
cmdline_parser_internal (int argc, char **argv, struct cmd_params *args_info,
                        struct cmdline_parser_params *params, const char *additional_error);

static int
cmdline_parser_required2 (struct cmd_params *args_info, const char *prog_name, const char *additional_error);
...
static
void init_args_info(struct cmd_params *args_info)
{
...
cmdline_parser_print_version (void)
{
  ...
  if (strlen(cmd_params_versiontext) > 0)
    printf("\n%s\n", cmd_params_versiontext);
}

static void print_help_common(void) {
  cmdline_parser_print_version ();

  if (strlen(cmd_params_purpose) > 0)
    printf("\n%s\n", cmd_params_purpose);

  if (strlen(cmd_params_usage) > 0)
    printf("\n%s\n", cmd_params_usage);

  printf("\n");

  if (strlen(cmd_params_description) > 0)
    printf("%s\n\n", cmd_params_description);
}
...
cmdline_parser_print_help (void)
{
  int i = 0;
  print_help_common();
  while (cmd_params_help[i])
    printf("%s\n", cmd_params_help[i++]);
}

void
cmdline_parser_init (struct cmd_params *args_info)
{
...
static void
cmdline_parser_release (struct cmd_params *args_info)
{
...
int
cmdline_parser_dump(FILE *outfile, struct cmd_params *args_info)
{
  int i = 0;
...
int
cmdline_parser_file_save(const char *filename, struct cmd_params *args_info)
{
  FILE *outfile;
  int i = 0;
...
void
cmdline_parser_free (struct cmd_params *args_info)
{
...
int
cmdline_parser (int argc, char **argv, struct cmd_params *args_info)
{
  return cmdline_parser2 (argc, argv, args_info, 0, 1, 1);
}

int
cmdline_parser_ext (int argc, char **argv, struct cmd_params *args_info,
                   struct cmdline_parser_params *params)
{
  int result;
...
int
cmdline_parser2 (int argc, char **argv, struct cmd_params *args_info, int override, int initialize, int check_required)
{
  int result;
  struct cmdline_parser_params params;
...
int
cmdline_parser_required (struct cmd_params *args_info, const char *prog_name)
{
...
cmdline_parser_internal (
  int argc, char **argv, struct cmd_params *args_info,
                        struct cmdline_parser_params *params, const char *additional_error)
{
  int c;	/* Character of the parsed option.  */

  int error_occurred = 0;
  struct cmd_params local_args_info;
